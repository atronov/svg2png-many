...
function svg2PngFiles(fileMap) {
    ...
    var pages = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : PARALLEL_PAGES;
...
function svg2PngDir(srcDir, dstDir) {
    ...
    var pages = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : PARALLEL_PAGES;
    ...
    return new Promise(function (resolve, reject) {
        _fs2.default.readdir(srcDir, function (error, files) {
            ...
            if (!_fs2.default.existsSync(dstDir)) {
                (0, _mkdirp.mkdirp)(dstDir, function () {
...
function createFile(dstPath, buffer, reject, resolve) {
...
function saveBuffer(distFilePath, buffer) {
    log(distFilePath + ' will be saved ');

    return new Promise(function (resolve, reject) {
        createFile(distFilePath, buffer, reject, resolve);
    });
}
